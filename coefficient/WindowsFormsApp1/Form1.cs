...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            ans += string.Format("8T的正常溝=63V\r\n");
            ans += string.Format("9T的正常溝=70V\r\n");
            ans += string.Format("10T的正常溝=80V\r\n");
            ans += string.Format("12T的正常溝=100V\r\n");
            ans += string.Format("15T的正常溝=120V\r\n");
            ans += string.Format("16T的正常溝=120V\r\n");
